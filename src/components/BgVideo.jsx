...
export const BgVideo = () => {
  return (
    <div className="relative w-screen overflow-hidden" style={{ height: 'calc(100vh - 70px)' }}>
      ...
      <div className="flex flex-col justify-center items-center relative top-[75%] text-white gap-y-8">
        <div className=' bg-white h-14 w-7 rounded-3xl flex items-center justify-center'>
